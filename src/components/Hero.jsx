    ...
    <section className="relative py-16 sm:py-24 px-4 sm:px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <motion.div
          ...
          className="absolute top-1/6 left-1/5 w-96 h-96 rounded-full bg-[#dc2626]/20 blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.3, 1, 1.3],
          ...
          className="absolute bottom-1/6 right-1/5 w-[28rem] h-[28rem] rounded-full bg-[#059669]/20 blur-3xl"
        />
        <motion.div
          animate={{
            scale: [0.9, 1.2, 0.9],
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[34rem] h-[34rem] rounded-full bg-[#3b82f6]/15 blur-3xl"
        />
      </div>
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border-2 border-[#18181b] text-xs font-mono text-[#18181b] shadow-[2.5px_2.5px_0px_#18181b] cursor-default transition-all hover:shadow-[4px_4px_0px_#dc2626]"
        >
          ...
          <span className="text-[#52525b] font-medium">Notion + Gemini Autonomous Engine</span>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="space-y-4 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-[#18181b] leading-[1.08]">
            ...
            <motion.span
              animate={{
                color: ["#dc2626", "#ef4444", "#b91c1c", "#dc2626"],
              }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              className="text-[#dc2626] underline decoration-4 decoration-[#18181b] inline-block relative"
            >
              Completely.
            </motion.span>
          </h1>
          ...
          <p className="text-base sm:text-xl text-[#52525b] max-w-2xl mx-auto leading-relaxed">
            An <strong className="text-[#18181b] font-bold">autonomous backend automation service</strong> that eliminates repetitive student requests. Notion serves as the control center, Gemini AI classifies incoming tickets, and verified real-world actions execute in seconds.
          </p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
          ...
          >
            ...
            <div className="absolute inset-0 w-1/2 h-full bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-[-20deg] group-hover:translate-x-[300%] transition-transform duration-700 pointer-events-none" />
          ...
          >
            <Link
              href="/dashboard"
              className="btn-secondary btn-secondary-lg text-sm w-full sm:w-auto shadow-[3px_3px_0px_#18181b] hover:shadow-[5px_5px_0px_#18181b] transition-all group"
            >
              ...
              <span className="w-2 h-2 rounded-full bg-[#059669] animate-pulse ml-1" />
            </Link>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative p-5 sm:p-6 rounded-2xl bg-white border-2 border-[#18181b] shadow-[3.5px_3.5px_0px_#18181b] max-w-3xl mx-auto overflow-hidden transition-all hover:shadow-[6px_6px_0px_#18181b]"
        >
          {/* Animated subtle top border light sweep */}
          <div className="absolute top-0 left-0 right-0 h-[3px] bg-[#f4f3ef] overflow-hidden">
            <motion.div
              animate={{ x: ["-100%", "200%"] }}
              transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
              className="w-1/3 h-full bg-gradient-to-r from-transparent via-[#dc2626] to-transparent"
            />
          </div>

          <div className="flex items-center justify-between mb-3 px-1">
            <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#71717a] flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-[#059669] animate-pulse" />
              <span>5-Stage Real-Time Pipeline Architecture</span>
            </span>
            <span className="text-[10px] font-mono font-bold text-[#059669] bg-[#ecfdf5] px-2 py-0.5 rounded border border-[#059669]/30">
              ⚡ ~1.4s TOTAL LATENCY
            </span>
          </div>
            ...
            {pipelineStages.map((stage, idx) => (
              <div key={stage.label} className="flex items-center gap-2 sm:gap-3">
                <motion.span
                  ...
                  transition={{ type: "spring", stiffness: 400, damping: 15 }}
                  className={`px-3 py-1.5 rounded-lg border-2 border-[#18181b] transition-all cursor-default shadow-[1.5px_1.5px_0px_#18181b] ${
                    stage.highlight
                      ? "bg-[#dc2626] text-white shadow-[2px_2px_0px_#18181b]"
                      : "bg-[#fcfbfa] hover:bg-white hover:shadow-[2.5px_2.5px_0px_#18181b]"
                  }`}
                >
