            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-lg bg-[#18181b] text-white flex items-center justify-center shadow-[1.5px_1.5px_0px_#dc2626]">
                    <step.icon className="w-5 h-5 text-white" aria-hidden="true" focusable="false" />
                  </div>
                  <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-[#f4f3ef] border border-[#18181b] text-[#18181b]">
        ...
        >
          ...
          <div className="text-center sm:text-left flex-1">
            <h4 className="font-bold text-[#18181b] text-sm flex items-center justify-center sm:justify-start gap-2">
              ...
              <span className="badge-live text-[9px]">BOT TOKEN PROOF</span>
            </h4>
