              ...
              <div>
                <div className="flex items-center justify-between mb-5">
                  <motion.div
                    ...
                    className="w-13 h-13 rounded-xl bg-[#18181b] dark:bg-[#dc2626] text-white flex items-center justify-center shadow-[2.5px_2.5px_0px_#dc2626] dark:shadow-[0_0_15px_rgba(220,38,38,0.5)] transition-transform p-3"
                  >
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)] mb-3 group-hover:text-[#dc2626] transition-colors flex items-center justify-between">
                  <span>{f.title}</span>
