...
|---|:---:|---|---|:---:|---|
| **BUG-001** | 🔴 **CRITICAL** | Functional Logic | [`src/app/dashboard/page.js`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/app/dashboard/page.js) | ✅ **FIXED** | Custom prompt & sender input in Engine Canvas was overwritten by hardcoded placeholder data. |
| **BUG-002** | 🟠 **HIGH** | UI / Layout | [`src/components/dashboard/MatchScoreboard.jsx`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/app/dashboard/page.js) | ✅ **FIXED** | Giant top scoreboard banner consumed ~40% of screen height, clipping the 3-column dashboard layout. |
| **BUG-003** | 🟠 **HIGH** | Data Integrity | [`src/app/dashboard/page.js`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/app/dashboard/page.js) | ✅ **FIXED** | Malformed dummy emails (`ankit_invalid@`) in initial incident events broke mailer dispatch pipelines. |
| **BUG-004** | 🟡 **MEDIUM** | Navigation UX | [`src/components/dashboard/EventStreamTimeline.jsx`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/components/dashboard/EventStreamTimeline.jsx) | ✅ **FIXED** | Duplicate workspace navigation cards in left sidebar pushed the live incident queue off-screen. |
| **BUG-005** | 🟡 **MEDIUM** | Header Navigation | [`src/components/Navbar.jsx`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/components/Navbar.jsx) | ✅ **FIXED** | Redundant "Cockpit" button in top header duplicated the adjacent "Live Cockpit" navigation link. |
| **BUG-006** | 🟡 **MEDIUM** | UI Polish | [`src/components/dashboard/TacticalEngineCanvas.jsx`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/components/dashboard/TacticalEngineCanvas.jsx) | ✅ **FIXED** | Redundant `Avg SLA: 1.42s` badge in input header duplicated the dedicated SLA telemetry sidebar. |
...
| **BUG-008** | 🛡️ **SECURITY** | Injection Guardrail | [`src/lib/certificate.js`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/lib/certificate.js) | ✅ **VERIFIED** | Enforced full `escapeHtml()` sanitization across student names and event strings to prevent XSS. |
| **BUG-009** | ⚡ **RELIABILITY** | Fallback Cascade | [`src/lib/mailer.js`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/lib/mailer.js) | ✅ **VERIFIED** | Automatic failover to authenticated Gmail SMTP when Resend key contains placeholder `re_xxxxxxxxx`. |
| **BUG-010** | 🛡️ **DATA INTEGRITY** | Memory & Dedup | [`src/app/api/pipeline/route.js`](file:///c:/Users/ABHI%20SHARMA/OneDrive/Desktop/New%20folder/src/app/api/pipeline/route.js) | ✅ **VERIFIED** | 24-hour MD5 deduplication cache with automated TTL cleanup to prevent duplicate spam and memory leaks. |
